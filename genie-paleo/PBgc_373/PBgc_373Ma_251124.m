...
%
par_wor_name='PBgc_373'; % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l'; % ['STRING'] input format/GCM name
par_expid='373Ma'; % ['STRING'] input experiment/data name
par_cfgid='CONFIG.16lvl'; % ['STRING'] optional template base-config
par_age=373; % [0.0-4570.0] optional age (Myr)
par_mask_name='PED1_373.mask'; % ['STRING'] mask file name
%
