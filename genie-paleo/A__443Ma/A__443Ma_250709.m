...
%
par_wor_name='A__443Ma'; % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l'; % ['STRING'] input format/GCM name
par_expid='443Ma'; % ['STRING'] input experiment/data name
par_cfgid='CONFIG.16lvl'; % ['STRING'] optional template base-config
par_age=443; % [0.0-4570.0] optional age (Myr)
par_mask_name='A__443Ma.mask'; % ['STRING'] optional mask adjustment name
%
% *** INPUT + OUTPUT SETTINGS ******************************************* %
%
par_pathin='hires'; % ['STRING'] path to input dir
par_pathout='hires_output'; % ['STRING'] path to output dir
