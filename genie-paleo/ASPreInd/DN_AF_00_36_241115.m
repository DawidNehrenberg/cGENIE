...
%
par_wor_name='ASPreInd';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tdzvg';             % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
par_pathin='HiResSedData';   % ['STRING'] path to input dir
par_pathout='HiResSedOutput'; % ['STRING'] path to output dir
...
par_min_oceann=0;             % [0-9999] minimum lake size (# cells)
%
