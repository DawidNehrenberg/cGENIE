...
%
par_wor_name='A__000Ma'; % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l'; % ['STRING'] input format/GCM name
par_expid='texpa1_0Ma'; % ['STRING'] input experiment/data name
par_cfgid='CONFIG.16lvl'; % ['STRING'] optional template base-config
par_age=0; % [0.0-4570.0] optional age (Myr)
par_mask_name='A__000Ma.mask'; % ['STRING'] optional mask adjustment name
%
% *** INPUT + OUTPUT SETTINGS ******************************************* %
%
par_pathin='Valdes_2021'; % ['STRING'] path to input dir
par_pathout='Phanerozoic'; % ['STRING'] path to output dir
par_plotformat='png'; % 'png' ,'jpg','pdf' (high res), '' for NONE
opt_user=false; % [false/true] force user input to grid
%
% *** GRID -- HORIZONTAL ************************************************ %
%
par_max_i=72; % [1-72] # grid cells in longitude dir (i)
par_max_j=72; % [1-72] # grid cells in latitude  dir (j)
