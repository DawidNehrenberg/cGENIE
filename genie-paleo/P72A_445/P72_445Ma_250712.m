...
%
par_wor_name='P72A_445';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='teXPl_445Ma';             % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
par_pathin='Phanero-72_input';   % ['STRING'] path to input dir
par_pathout='Phanero-72_output'; % ['STRING'] path to output dir
...
par_age=445.0;                   % [0.0-4570.0] optional age (Myr)
%
% *** OPTIONS -- MAIN *************************************************** %
%
...
par_min_oceann=10;             % [0-9999] minimum lake size (# cells)
%
