...
%
par_wor_name='DN_AF_56';       % ['STRING'] 8-char (output) config name
...
par_pathout='Outputs'; % ['STRING'] path to output dir
...
% *** GRID RESOLUTION *************************************************** %
%
par_max_i=48;                  % [1-72] # grid cells in longitude dir (i)
par_max_j=48;                  % [1-72] # grid cells in latitude  dir (j)
