...
%
par_wor_name='teXPm_72';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='teXPm';             % ['STRING'] input experiment/data name
...
par_plotformat='pdf';          % 'png' ,'jpg','pdf' (high res), '' for NONE
...
opt_makeseds=true;            % [false/true] make SEDGEM files
