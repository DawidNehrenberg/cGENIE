...
%
par_wor_name='f19b_22c';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tdqpj';             % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
par_pathin='Farnsworth2019';   % ['STRING'] path to input dir
par_pathout='new_c'; % ['STRING'] path to output dir
...
par_lon_off=-180;            % [-360-0] longitude offset of grid start
...
par_min_oceann=5;             % [0-9999] minimum lake size (# cells)
%
