...
%
par_wor_name='P72B_441';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='teXPk_441Ma';             % ['STRING'] input experiment/data name
par_cfgid='CONFIG.16lvl';      % ['STRING'] optional template base-config
par_mask_name='P72B_441.mask'; % zero mask
par_age=441.0;                 % [0.0-4570.0] optional age (Myr)
%
