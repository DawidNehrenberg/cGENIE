...
%
par_wor_name='Priaboni';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tdluk';             % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
par_pathin='BRIDGE Group';   % ['STRING'] path to input dir
par_pathout='72x72'; % ['STRING'] path to output dir
...
par_age=35.55;                   % [0.0-4570.0] optional age (Myr)
%
% *** OPTIONS -- MAIN *************************************************** %
%
...
par_min_oceann=3;             % [0-9999] minimum lake size (# cells)
%
