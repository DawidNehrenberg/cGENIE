...
%
par_wor_name='PED1_375'; % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l'; % ['STRING'] input format/GCM name
par_expid='375Ma'; % ['STRING'] input experiment/data name
par_cfgid='CONFIG.16lvl'; % ['STRING'] optional template base-config
par_age=375; % [0.0-4570.0] optional age (Myr)
par_mask_name='PED1_375.mask'; % ['STRING'] mask file name
%
% *** INPUT + OUTPUT SETTINGS ******************************************* %
%
par_pathin='emulator_output'; % ['STRING'] path to input dir
par_pathout='PED_1'; % ['STRING'] path to output dir
