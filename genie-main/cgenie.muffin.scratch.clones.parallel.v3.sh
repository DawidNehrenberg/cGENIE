...
[ -d '/scratch/dn3g22/cgenie.muffin' ] && rm -rf /scratch/dn3g22/cgenie.muffin
...
#SBATCH --time=1:00:00
#SBATCH --mail-user=dn3g22@soton.ac.uk
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=/home/dn3g22/cgenie.jobs/cgenie.muffin.scratch.clones.parallel.out
