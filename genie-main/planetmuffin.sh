...
echo ma_ksic_loop=15 >> $CONFIGPATH/$CONFIGNAME #atm:sic
echo ma_kocn_loop=15 >> $CONFIGPATH/$CONFIGNAME #atm:ocn
...
#
# (6) SET CLIMATE MODEL RE-START FILE DETAILS
# -------------------------------------------
# Set default flags
...
if [ -n "$5" ]; then
  ...
  echo pl_rstdir_name=$RESTARTPATH"/plasim" >> $CONFIGPATH/$CONFIGNAME
