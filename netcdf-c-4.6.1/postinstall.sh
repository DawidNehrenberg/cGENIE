...
if [ "x$DOAUTOTOOL" = "xTRUE" ]; then
    ...
    if [ "x$DOACTION" = "xbuild" ]; then
        ...
        LIBS="-lm " CFLAGS="-I/mainfs/scratch/dn3g22/cgenie.muffin/include" LDFLAGS="-L/mainfs/scratch/dn3g22/cgenie.muffin/lib" ./configure --prefix=/mainfs/scratch/dn3g22/cgenie.muffin $STATIC_BUILD $SHARED_BUILD
        LIBS="-lm " make
        LIBS="-lm " make check
    fi
